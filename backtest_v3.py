...
# ===== 回測期間設定 =====
START_DATE = "2025-01-01"  # 開始日期 (修改為有數據的日期)
END_DATE = "2025-01-31"  # 結束日期 - 延長至3天以看到完整回測效果
# 移除CSV依賴，全部使用數據庫
...
class FundingRateBacktest:
    ...
    def exit_position(self, pair, current_time):
        ...
        # 記錄離場事件 (此時 position_detail 還包含即將離場的持倉)
        self.add_event_log(
